...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-info accordion" id="accordionSidebar">
                 ...
                 <form method="POST" action="proses_editkelas.php" enctype="multipart/form-data" >
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <button type="submit" class="btn btn-fill btn-info"><i class="fas fa-check"></i></button>
               </div>
                </form>  
